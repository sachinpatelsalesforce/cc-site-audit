    ...
    <div className="flex flex-col h-full bg-gray-900">
      ...
      {mode === 'proxy' && (
        <div className="flex-1 relative flex flex-col">
          {/* Banner */}
          <div className="flex items-center justify-between gap-3 px-3 py-2 bg-amber-50 border-b border-amber-200 flex-shrink-0">
            <div className="flex items-center gap-2 min-w-0">
              <svg className="w-4 h-4 text-amber-500 flex-shrink-0" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={2}>
                <path strokeLinecap="round" strokeLinejoin="round" d="M13 16h-1v-4h-1m1-4h.01M21 12a9 9 0 11-18 0 9 9 0 0118 0z" />
              </svg>
              <p className="text-xs text-amber-800">
                <span className="font-semibold">Viewing via proxy.</span> For the best experience, open the site in a new tab alongside this checklist.
              </p>
            </div>
            <a
              href={normalised}
              target="_blank"
              rel="noopener noreferrer"
              className="flex-shrink-0 inline-flex items-center gap-1.5 text-xs font-semibold text-amber-800 bg-amber-100 hover:bg-amber-200 border border-amber-300 px-2.5 py-1 rounded-lg transition-colors whitespace-nowrap"
            >
